...
export const Route = createFileRoute("/")({
  head: () => ({
    meta: [
      { title: "Annapurna — गरमागरम नाश्ता ऑनलाइन" },
      {
        name: "description",
        content:
          "Order fresh Bel, Mung Vada and Samosa online from Annapurna. ताजे आणि चविष्ट नाश्त्याचे पदार्थ, फक्त ₹15.",
      },
      { property: "og:title", content: "Annapurna — गरमागरम नाश्ता ऑनलाइन" },
      {
    ...
    <div className="min-h-screen bg-background">
      ...
      <section id="contact" className="mx-auto max-w-3xl px-4 pb-10">
        <div className="card-soft overflow-hidden">
          ...
          />
          <div className="p-5">
            <h2 className="text-xl font-bold">📍 Annapurna</h2>
      ...
      <footer className="px-4 py-6 text-center text-sm text-muted-foreground">
        © {new Date().getFullYear()} Annapurna ·{" "}
